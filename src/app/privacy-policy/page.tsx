            ...
            {[
              {
                ...
                content: (
                  ...
                  >
                    NyayaMitra ("we," "our," or "us") is committed to protecting
                    your privacy. This Privacy Policy explains how we collect,
                    use, disclose, and safeguard your information when you use
                    our AI-powered legal assistance platform, including our
                  ...
                  <motion.div variants={itemVariants} className="space-y-4">
                    <div>
                      ...
                      <ul className="list-disc list-inside text-gray-700 space-y-1">
                        ...
                        <li>Contact information for legal aid referrals</li>
                        <li>
              ...
              },
              {
                ...
                content: (
                  ...
                  >
                    ...
                    <li>
                      Connect you with appropriate legal aid services when
                      requested
                    </li>
                    <li>
              ...
              },
              {
                ...
                content: (
                  <motion.div variants={itemVariants}>
                    ...
                    <ul className="list-disc list-inside text-gray-700 space-y-1">
                      <li>
                        With legal aid organizations when you request assistance
                      </li>
              ...
              },
              {
                ...
                content: (
                  <motion.p variants={itemVariants} className="text-gray-700">
                    NyayaMitra is not intended for children under 13 years of
              ...
              },
              {
                ...
                content: (
                  <motion.p variants={itemVariants} className="text-gray-700">
                    ...
                    date. Your continued use of NyayaMitra after any changes
