      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl font-bold text-blue-900 mb-4">
            Common Questions NyayaMitra Can Answer
          </h2>
        ...
        >
          ...
          >
            ...
            <p className="text-gray-600 text-sm">
              NyayaMitra explains the notice in simple terms and guides you
          ...
          >
            ...
            <p className="text-gray-600 text-sm">
              Learn about your rights against harassment and legal options for
              debt resolution.
            </p>
          </motion.div>
