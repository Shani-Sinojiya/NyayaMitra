      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.div variants={itemVariants}>
            <h3 className="text-lg font-semibold mb-4">NyayaMitra</h3>
            <p className="text-gray-400 text-sm">
              Your AI-powered legal friend making Indian law accessible in local
              languages.
            </p>
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="flex space-x-4 mb-4">
              {["facebook-f", "twitter", "instagram", "linkedin-in", "whatsapp"].map(
                (platform, index) => (
                  <motion.a
                    key={platform}
                    href="#"
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            >
              &copy; {new Date().getFullYear()} NyayaMitra. All rights reserved.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              whileInView={{ opacity: 1, x: 0 }}
