      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            NyayaMitra is designed specifically for rural India's legal needs
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            },
            {
              ...
              description:
                "Available in Hindi, Gujarati, Marathi, Bhojpuri, Tamil, Telugu, and more with regional legal terminology.",
            },
            {
              ...
              description:
                "Upload court notices or legal documents to get simple summaries in your language.",
            },
            {
