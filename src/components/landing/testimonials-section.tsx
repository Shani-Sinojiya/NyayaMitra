      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl font-bold text-blue-900 mb-4">
            What People Say About NyayaMitra
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Trusted by rural citizens, NGOs, and legal professionals
          </p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <p className="text-gray-600 italic">
              "NyayaMitra explained land dispute laws in Bhojpuri with stories I
          ...
          >
            ...
            <p className="text-gray-600 italic">
              "We use NyayaMitra in our women's empowerment programs. The voice
              interface helps illiterate women access legal knowledge."
            </p>
            <div className="mt-4 flex text-yellow-400">
              <i className="fas fa-star"></i>
              <i className="fas fa-star"></i>
          ...
          >
            ...
            <p className="text-gray-600 italic">
              ...
              legal systems. It's accurate yet simple enough for anyone."
            </p>
            <div className="mt-4 flex text-yellow-400">
              <i className="fas fa-star"></i>
              <i className="fas fa-star"></i>
